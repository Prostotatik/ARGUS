...
def mk_pdf(text, style):
    ...
    page.insert_text((50,y), title(text), fontsize=14); y+=30
    rows=kv(text)
    if style=="lines":
        for a,b in rows:
...
for nm,a in [("docx_para",("docx","docx","para","para")),("docx_t2",("docx","docx","table2","table2")),("docx_t4",("docx","docx","table4","table4")),("docx_transposed",("docx","docx","table_hdr_col","table_hdr_col")),
             ("xlsx_ab",("xlsx","xlsx","ab","ab")),("xlsx_bc",("xlsx","xlsx","bc","bc")),("xlsx_hdr",("xlsx","xlsx","hdr","hdr")),("xlsx_numeric",("xlsx","xlsx","numeric","numeric")),
             ("pdf_lines",("pdf","pdf","lines","lines")),("pdf_cols",("pdf","pdf","cols","cols")),
             ("mixed_txt_pdf",("txt","pdf","x","cols")),("mixed_docx_xlsx",("docx","xlsx","t2","ab")),("scan",("pdf","pdf","scan","scan"))]:
    try: ev2(nm,*a)
    except Exception as ex: print(nm,"EXC",repr(ex)[:200])
